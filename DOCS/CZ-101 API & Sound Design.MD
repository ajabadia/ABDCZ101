...
### 3.2 Jitter de Oscilador (Inestabilidad Analógica)
...
### 3.4 Ruido Rosa Vintage (Noise Floor)
...
## PARTE 4: TABLA COMPARATIVA DE TÉCNICAS

| Técnica | Propósito | Intensidad Recomendada | Resultado Sonoro |
|---------|----------|----------------------|------------------|
| **Aliasing** | Carácter digital retro | 0.2-0.4 | Brillo vintage, "8-bit feel" |
| **Jitter** | Inestabilidad analógica | 0.1-0.2 | Calidez "viva", movimiento |
| **Saturación** | Límites suaves transistor | 0.1-0.3 | Gordura armónica, presencia |
| **Ruido Rosa** | Noise floor realista | 0.0003-0.0005 | Profesionalismo, cohesión |
| **Envelope Rounding** | Suavizado transiciones | 0.2-0.4 | Menos clics, más orgánico |
| **Bit Crushing** | Cuantización 14-bits | Siempre ON | Autenticidad digital |

---

## PARTE 5: PRESETS DE SONIDO RECOMENDADOS

### Uso General: "Balanced" (80% Authentic, 20% Limpio)
AuthenticSoundSettings::balancedConfig()
// Perfecto para producción y creación de música
// Suena auténtico pero sin artefactos molestos

### Máxima Similitud Hardware: "Authentic" (100% Match)
AuthenticSoundSettings::authenticSoundConfig()
// Para emulación perfecta del CZ-101 original
// Suena exactamente como el hardware de 1984
// Puede sonar "vintage" para oídos modernos

### Producción Moderna: "Clean" (Minimal Artifacts)
AuthenticSoundSettings::cleanConfig()
// Para mezclas limpias y profesionales
// Mantiene el carácter, elimina ruido
// Ideal para EDM, synthpop moderno
